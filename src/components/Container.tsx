...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Portfolio | Moksh Arora",
    description: `AI/ML & Computer Vision Enthusiast'
`,
  ...
  <link rel="icon" href="/assets/logo.png" type="image/png" />
        ...
        <meta
          property="og:url"
          content={`https://portfolio.moksharora.com${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://portfolio.moksharora.com${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
  <meta property="og:site_name" content="Moksh Arora" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="Moksh Arora" />
